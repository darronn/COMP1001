...
//compile with gcc q1.c -o p -O3 -D_GNU_SOURCE  -march=native -mavx -lm -D_GNU_SOURCE -fopenmp -Wall
...
float  y[M], z[M] __attribute__((aligned(64))); 
float A[N][N], x[N], w[N] __attribute__((aligned(64))); 
